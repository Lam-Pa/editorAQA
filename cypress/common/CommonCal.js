...
uploadFiletoProject(projectTitle) {
    if (projectTitle === cal[35]) {
        this.uploadFile(onePhoto);
        cy.get('[class*="css-ir7jip"] [class*="projectPreview"]')
            .eq(1)
            .should('exist');
    } else if (projectTitle === cal[25]) {
